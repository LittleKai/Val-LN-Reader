...
public class DisplayChapterContentActivity extends AppCompatActivity implements LoadJson.OnFinishLoadJSonListener {
    ...
    private LinearLayout layoutMenu, llout_setting_reading, ll_reload;
...
//        editor.commit();
        textSizeCurrent = sharedPreferences.getInt("TextSize", 20);
        String fontName = sharedPreferences.getString("FontName", "Palatino");
        String showedToolbarType = sharedPreferences.getString("ShowedToolbarType", "Scroll");
...
//            llout_setting_reading.setVisibility(LinearLayout.GONE);//INVISIBLE | VISIBLE
    ...
    public void setFonts(View view) {
        if (firstLoad) {
            final Dialog dialog = new Dialog(DisplayChapterContentActivity.this);
