...
//    }
    ...
    public static AlertDialog createYesNoDialog(Context context, String message, String caption, DialogInterface.OnClickListener listener) {
        ...
        builder.setNegativeButton("Hủy", listener);
...
//        /revision/latest?cb=20160524034528
        if (loc.endsWith("/"))
...
//            return Constants.ROOT_HTTPS + Constants.ROOT_URL;
    ...
    public static boolean getBigImageDownloadPreferences(Context ctx) {
        return PreferenceManager.getDefaultSharedPreferences(ctx).getBoolean("download_big_image", false);
    }
    ...
    public static String getBackgroundColor(Context ctx) {
        return PreferenceManager.getDefaultSharedPreferences(ctx).getString(Constants.PREF_CSS_BACKGROUND, "#004455");
    }

    public static String getForegroundColor(Context ctx) {
        return PreferenceManager.getDefaultSharedPreferences(ctx).getString(Constants.PREF_CSS_FOREGROUND, "#c4bdbd");
    }

    public static String getLinkColor(Context ctx) {
        return PreferenceManager.getDefaultSharedPreferences(ctx).getString(Constants.PREF_CSS_LINK_COLOR, "#31fde5");
    }
