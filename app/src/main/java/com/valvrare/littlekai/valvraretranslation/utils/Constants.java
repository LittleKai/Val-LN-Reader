...
public class Constants {
    public static final String VAL_URL_ROOT = "http://valvrareteam.com";
    public static final String SNK_URL_ROOT = "http://sonako.wikia.com";

    public static final String URL_Category = "http://sonako.wikia.com/wiki/Category:";
    public static final String category_exhibition_sort_alphabet = "sort=alphabetical&display=exhibition";
    private static final String URL_Completed_LightNovel = "http://sonako.wikia.com/wiki/Category:Ho%C3%A0n_th%C3%A0nh";
    public static final String[] SNK_SUB_CATEGOPRIES = {"Action", "Adult", "Adventure", "Comedy", "School", "Drama", "Ecchi", "Fantasy", "Game", "Gender Bender", "Harem",
            "Historical", "Horror", "Martial Arts", "Mature", "Mecha", "Mystery", "Post-Apocalypse",
            "Psychological", "Romance", "School Life", "Sci-fi", "Seinen", "Shotacon", "Shoujo", "Shounen",
            "Slice of life", "Supernatural", "Tragedy", "Event Xuân 2015", "Chinese"};
    public static final String[] SNK_NOVEL_TYPES = {"Active Projects", "Idle Projects", "Inactive Projects", "Original Light Novel",
            "Stalled Projects", "Teaser", "Hoàn thành", "Host Project"};

    public static String getURL_Completed_LightNovel() throws UnsupportedEncodingException {
        return URLDecoder.decode(URL_Completed_LightNovel, "utf8");
    }

    public static final String URL_Active_LightNovel = "http://sonako.wikia.com/wiki/Category:Active_Projects";
    public static final String URL_Inactive_LightNovel = "http://sonako.wikia.com/wiki/Category:Inactive_Projects";
    public static final String URL_Idle_LightNovel = "http://sonako.wikia.com/wiki/Category:Idle_Projects";
    public static final String URL_Teaser_LightNovel = "http://sonako.wikia.com/wiki/Category:Teaser";
    public static final String URL_Host_LightNovel = "http://sonako.wikia.com/wiki/Category:Host_Project";

    public static final String URL_Original_Novel = "http://sonako.wikia.com/wiki/Category:Original_Light_Novel";
    public static final String ROOT_URL = "//valvrareteam.com";
    ...
    public static final String PREF_ZOOM_ENABLED = "zoom_enable";
...
///////    public static final float DISPLAY_SCALE = LNReaderApplication.getInstance().getResources().getDisplayMetrics().density;
    ...
    public Constants() throws UnsupportedEncodingException {
    }
}
